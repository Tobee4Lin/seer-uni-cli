<template>
	<view>
		...
		<view :class="{
		 ...
		 class="uni-fab__circle uni-fab__plus" :style="{ 'background-color': (isSearch || isRing) ? '#FFF' : styles.buttonColor }" @click="_onClick">
		 <template v-if="isSearch">
			<image style="width: 50rpx;height: 50rpx;" src="../../static/user/check.png" mode="aspectFill"></image>
		 </template>
		 <template v-else-if="isRing">
			<image style="width: 50rpx;height: 50rpx;" src="../../static/ring.png" mode="aspectFill"></image>
		 </template>
		 <template v-else>
