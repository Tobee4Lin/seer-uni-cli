<template>
	<view v-if="show" class="uni-noticebar" :style="{ backgroundColor: backgroundColor }" @click="onClick">
		...
		<uni-icons v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-icon" type="sound" :color="color"
		 size="14" />
		 <text style="font-size: 14px;line-height: 18px;color: #0091FF;">公告：</text>
		<!-- #endif -->
		<view ref="textBox" class="uni-noticebar__content-wrapper" :class="{'uni-noticebar__content-wrapper--scrollable':scrollable, 'uni-noticebar__content-wrapper--single':!scrollable && (single || moreText)}">
			<view :id="elIdBox" class="uni-noticebar__content" :class="{'uni-noticebar__content--scrollable':scrollable, 'uni-noticebar__content--single':!scrollable && (single || moreText)}">
				<swiper style="height: 18px;" :autoplay="true" interval="6000" :circular="true" :vertical="true" duration="700" @change="change">
					<swiper-item v-for="(item, index) in noticeList" :key="index" @click="clickMore(index)">
						<text class="uni-noticebar__content-text" style="color: #353535;">{{item.title}}</text>
					</swiper-item>
				</swiper>
		...
		<view v-if="showGetMore === true || showGetMore === 'true'" class="uni-noticebar__more" @click="clickMore(currentIndex)">
