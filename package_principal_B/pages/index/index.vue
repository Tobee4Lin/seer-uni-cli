<template>
	<view class="content">
		...
		<!-- 主体 -->
		<view style="margin-bottom: 200rpx;" :style="{'display':showIndex == 1 ?'block':'none'}">
			<Principal ref="principal" />
		</view>
		<!-- 消息 -->
		<view style="margin-bottom: 200rpx;" :style="{'display':showIndex == 2 ?'flex':'none'}">
			<Notify ref="notify" style="width: 100%;"/>
		</view>
		<!-- 个人中心 -->
		<view :style="{'display':showIndex == 3? 'block':'none'}">
...
<script>
	...
	import Principal from "../../self-comps/principal.vue";
		...
		data() {
			return {
				...
				tabNavList: [{
					...
					"icon": "cuIcon-homefill",
					"inactiveImg": "/static/tabBar/supplier.png",
					"activeImg": "/static/tabBar/supplier-active.png",
					"name": "主体"
				}, {
					"icon": "cuIcon-apps",
